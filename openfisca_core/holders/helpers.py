...
def set_input_dispatch_by_period(holder, period, array):
    ...
    if holder.variable.definition_period == Unit.Month:
        cached_period_unit = Unit.Month
    elif holder.variable.definition_period == Unit.Year:
        cached_period_unit = Unit.Year
    else:
